     ...
     #   BasePage(driver).find_element_loc(LocatorOrder.top_order_button)
        ...
        OrderPage(driver) \
                .order_part_scooter_drv(LocatorOrder.scooter_dr_text,
                                        LocatorOrder.firstname, DataVar.list_firstname[0],
                                        LocatorOrder.surname, DataVar.list_surname[0],
                                        LocatorOrder.addsress, DataVar.list_address[0],
                                        LocatorOrder.phone_number, DataVar.list_phone[0],
                                        LocatorOrder.list_railway_button, LocatorOrder.railway_station,
                                        LocatorOrder.next_button)
        OrderPage(driver).order_part_rent(LocatorOrder.date_delivery, DataVar.list_delivery[0],
